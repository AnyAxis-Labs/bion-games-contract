 ...
 */
contract LotteryGame is ReentrancyGuard, ILottery, Ownable {
     ...
     * @param _tokenAddress: address of the play token
    ...
    function buyTickets(
        ...
        // Transfer to tokens to this contract
    ...
    function claimTickets(
        ...
        token.safeTransfer(msg.sender, rewardToTransfer);
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId]
            .amountCollected - amountToShareToWinners);
    ...
    function startLottery(
        ...
        require(
            (_priceTicket >= minPriceTicket) &&
                (_priceTicket <= maxPriceTicket),
            "Outside of limits"
        );
    ...
    function recoverWrongTokens(
        ...
        require(_tokenAddress != address(token), "Cannot be play token");
     ...
     * @dev Only callable by owner
     * @param _minPriceTicket: minimum price of a ticket in Token
     * @param _maxPriceTicket: maximum price of a ticket in Token
     */
